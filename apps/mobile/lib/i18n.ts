...
const translations = {
  en: {
    ...
    devices: {
      title: "Devices",
      cameraTitle: "Camera",
      cameraDescription: "Last BLE photo capture from Stardust Sense.",
      cameraUnavailable: "No photo captured yet",
      cameraStatusIdle: "Use capture on a connected device.",
      latestPhoto: "Latest Stardust Sense photo",
      testTitle: "Photo test",
      testDescription: "Connect Stardust Sense over Bluetooth and capture one photo.",
      connectDevice: "Connect device",
      capturePhoto: "Capture photo",
      capturingPhoto: "Capturing...",
      refresh: "Refresh",
      wifiTitle: "Wi-Fi photo transfer",
      wifiSsid: "Wi-Fi name",
  ...
  "zh-Hans": {
    ...
    devices: {
      title: "设备",
      cameraTitle: "摄像头",
      cameraDescription: "显示 Stardust Sense 最近一次通过 BLE 传回的照片。",
      cameraUnavailable: "还没有捕获照片",
      cameraStatusIdle: "连接设备后点击捕获。",
      latestPhoto: "最新 Stardust Sense 照片",
      testTitle: "拍照测试",
      testDescription: "通过蓝牙连接 Stardust Sense，然后捕获一张照片。",
      connectDevice: "连接设备",
      capturePhoto: "拍照",
      capturingPhoto: "拍照中...",
      refresh: "刷新",
