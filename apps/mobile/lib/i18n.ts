...
const translations = {
  en: {
    ...
    personal: {
      ...
      pendingDeviceReviews: "Device reviews",
      openLoops: "Open loops",
      journalCount: "Journal entries",
      episodeCount: "Episodes",
      screenOffEpisodeCount: "Screen-off",
      screenOffSource: "Screen-off capture",
  ...
  "zh-Hans": {
    ...
    personal: {
      ...
      deviceInboxDescription: "把屏幕外捕获转成已确认记忆",
      journalTitle: "日记",
      ...
      pendingCards: "待确认卡片",
      pendingDeviceReviews: "设备待审",
      openLoops: "未解问题",
      journalCount: "日志条目",
      episodeCount: "碎片",
      screenOffEpisodeCount: "屏幕外",
      screenOffSource: "屏幕外捕获",
      reflectionCount: "反思",
      entityCount: "实体",
      relationCount: "关系",
      ...
      recentReflectionsTitle: "最近反思",
      recentReflectionsDescription: "你已确认的高层自我理解",
      noRecentReflections: "还没有已确认的反思。",
      recentRelationsTitle: "最近关系",
      recentRelationsDescription: "从已确认记忆中长出的实体连接",
      noRecentRelations: "还没有已确认的关系。",
      recentCapturesTitle: "最近碎片",
      recentCapturesDescription: "最近的聊天、分享、图片、日历、设备和日志碎片",
      noRecentCaptures: "还没有捕获任何碎片。",
    },
    memory: {
      title: "记忆",
      empty: "还没有已确认的记忆。",
